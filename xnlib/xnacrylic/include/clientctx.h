...
extern void cc_draw_rect_filled (uint32_t* canvas,unsigned x, unsigned y, unsigned w, unsigned h, uint32_t col);
extern void cc_draw_vertical_line (uint32_t *canvas,unsigned x, unsigned y, unsigned length, uint32_t color);
extern void cc_draw_horizontal_line (uint32_t *canvas,unsigned x, unsigned y, unsigned length, uint32_t color);
extern void cc_draw_rect_unfilled (uint32_t* canvas,int x, int y, int width, int height, uint32_t color);
