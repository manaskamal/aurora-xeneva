...
_BSS	ENDS
CONST	SEGMENT
$SG2919	DB	'0123456789ABCDEF', 00H
	ORG $+3
$SG3058	DB	'.', 00H
CONST	ENDS
_DATA	SEGMENT
chars	DQ	FLAT:$SG2919
_DATA	ENDS
...
; 142  : 				//char buffer[sizeof(size_t) * 8 + 1];
; 143  : 				//sztoa(c, buffer, 10);
; 144  : 				//puts(buffer);
; 145  : 				puts((char*)c);
...
; 148  : 			{
; 149  : 				size_t x = va_arg(args, size_t);
...
; 161  : 			{
; 162  : 				double x = va_arg(args, double);
...
; 170  : 			{
; 171  : 				char buf[3];
; 172  : 				buf[0] = '%'; buf[1] = *format; buf[2] = '\0';
