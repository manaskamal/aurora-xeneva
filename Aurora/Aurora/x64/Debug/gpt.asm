...
CONST	SEGMENT
$SG3159	DB	'[GPT]: Initializing gpt partition tables....', 0aH, 00H
	ORG $+2
$SG3163	DB	'[GPT]: Signature %s', 0aH, 00H
	ORG $+3
$SG3164	DB	'[GPT]: Revision %x', 0aH, 00H
	ORG $+4
$SG3165	DB	'[GPT]: Total partition entries %d', 0aH, 00H
	ORG $+5
$SG3166	DB	'[GPT]: Partition table lba -> %d', 0aH, 00H
	ORG $+6
$SG3168	DB	'[GPT]: SizeOf(GPTPartitionTable) -> %d', 0aH, 00H
CONST	ENDS
