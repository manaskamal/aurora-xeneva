...
CONST	SEGMENT
$SG3099	DB	'[GPT]: Initializing gpt partition tables....', 0aH, 00H
	ORG $+2
$SG3103	DB	'[GPT]: Signature %s', 0aH, 00H
	ORG $+3
$SG3104	DB	'[GPT]: Revision %x', 0aH, 00H
	ORG $+4
$SG3105	DB	'[GPT]: Total partition entries %d', 0aH, 00H
	ORG $+5
$SG3106	DB	'[GPT]: Partition table lba -> %d', 0aH, 00H
	ORG $+6
$SG3108	DB	'[GPT]: SizeOf(GPTPartitionTable) -> %d', 0aH, 00H
CONST	ENDS
