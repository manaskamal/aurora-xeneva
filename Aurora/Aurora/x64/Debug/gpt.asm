...
CONST	SEGMENT
$SG2933	DB	'[GPT]: Initializing gpt partition tables....', 0aH, 00H
	ORG $+2
$SG2937	DB	'[GPT]: Signature %s', 0aH, 00H
	ORG $+3
$SG2938	DB	'[GPT]: Revision %x', 0aH, 00H
	ORG $+4
$SG2939	DB	'[GPT]: Total partition entries %d', 0aH, 00H
	ORG $+5
$SG2940	DB	'[GPT]: Partition table lba -> %d', 0aH, 00H
	ORG $+6
$SG2942	DB	'[GPT]: SizeOf(GPTPartitionTable) -> %d', 0aH, 00H
CONST	ENDS
