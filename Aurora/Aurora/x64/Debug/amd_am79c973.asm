...
_BSS	ENDS
CONST	SEGMENT
$SG3297	DB	'AMD NIC Interrupt handler++', 0aH, 00H
	ORG $+3
$SG3307	DB	'AMD PCNet card not found', 0aH, 00H
	ORG $+2
$SG3343	DB	'%x', 00H
	ORG $+1
$SG3308	DB	'AMD Interrupt pin -> %x', 0aH, 00H
	ORG $+3
$SG3344	DB	0aH, 00H
	ORG $+2
$SG3309	DB	'AMD PCNet card found -> device id -> %x, vendor id -> %x'
	DB	0aH, 00H
	ORG $+6
$SG3310	DB	'AMD Base Address -> %x, -> %x', 0aH, 00H
	ORG $+1
$SG3311	DB	'AMD Interrupt line -> %d', 0aH, 00H
	ORG $+6
$SG3338	DB	'AMD Mac Code -> ', 00H
	ORG $+7
$SG3347	DB	'MSI for amd not found', 0aH, 00H
CONST	ENDS
