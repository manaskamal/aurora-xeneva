...
_BSS	ENDS
CONST	SEGMENT
$SG3326	DB	'AMD NIC Interrupt handler++', 0aH, 00H
	ORG $+3
$SG3336	DB	'AMD PCNet card not found', 0aH, 00H
	ORG $+2
$SG3372	DB	'%x', 00H
	ORG $+1
$SG3337	DB	'AMD Interrupt pin -> %x', 0aH, 00H
	ORG $+3
$SG3373	DB	0aH, 00H
	ORG $+2
$SG3338	DB	'AMD PCNet card found -> device id -> %x, vendor id -> %x'
	DB	0aH, 00H
	ORG $+6
$SG3339	DB	'AMD Base Address -> %x, -> %x', 0aH, 00H
	ORG $+1
$SG3340	DB	'AMD Interrupt line -> %d', 0aH, 00H
	ORG $+6
$SG3367	DB	'AMD Mac Code -> ', 00H
	ORG $+7
$SG3376	DB	'MSI for amd not found', 0aH, 00H
CONST	ENDS
