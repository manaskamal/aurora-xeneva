...
; 92   : void sys_attach_ttype (int id) {

$LN3:
	mov	DWORD PTR [rsp+8], ecx
	sub	rsp, 56					; 00000038H

; 93   : 	get_current_thread()->ttype = id;
...
; 71   : void sys_kill (int pid, int signo) {
...
; 75   : 	//! For now, no signals are supported, just kill the process
; 76   : }
...
; 47   : 	int id = create_process (name, procnm);
...
; 48   : 	/*int master_fd = get_current_thread()->master_fd;
; 49   : 	ttype_dup_master(id, master_fd);*/
; 50   : 	return 0;
