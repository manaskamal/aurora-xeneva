...
_BSS	ENDS
CONST	SEGMENT
$SG3404	DB	'[ACPI]: data structures are incomplete', 0aH, 00H
$SG3407	DB	'[ACPI]: Already enabled', 0aH, 00H
	ORG $+7
$SG3409	DB	'PM1aCTRLBlock -> %x', 0aH, 00H
	ORG $+3
$SG3411	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3413	DB	'[ACPI]: Verifying pm1bCtrlBlock ', 0aH, 00H
	ORG $+6
$SG3416	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3421	DB	'[ACPI]: Fadt interrupt fired', 0aH, 00H
	ORG $+2
$SG3441	DB	'FACP', 00H
	ORG $+3
$SG3442	DB	'FACP', 00H
	ORG $+3
$SG3444	DB	'[ACPI]: Fadt table found', 0aH, 00H
	ORG $+2
$SG3447	DB	'CIPA', 00H
	ORG $+3
$SG3448	DB	'APIC', 00H
	ORG $+7
$SG3450	DB	'[ACPI]: Madt table found', 0aH, 00H
	ORG $+2
$SG3453	DB	'SRAT', 00H
	ORG $+3
$SG3454	DB	'SRAT', 00H
	ORG $+7
$SG3455	DB	'[ACPI]: Srat table found', 0aH, 00H
	ORG $+6
$SG3458	DB	'[ACPI]: Srat -> %d length -> %d', 0aH, 00H
	ORG $+7
$SG3475	DB	'[ACPI]: Srat memory affinity found ', 0aH, 00H
	ORG $+3
$SG3478	DB	'Mem start -> %x ', 0aH, 00H
	ORG $+6
$SG3479	DB	'Mem end -> %x ', 0aH, 00H
$SG3480	DB	'Mem Length -> %d MB ', 0aH, 00H
	ORG $+2
$SG3481	DB	'Numa Domain -> %d ', 0aH, 00H
	ORG $+4
$SG3482	DB	'Mem LLength -> %d', 0aH, 00H
	ORG $+5
$SG3484	DB	'[ACPI]: Srat cpu affinity found ', 0aH, 00H
	ORG $+6
$SG3486	DB	'[ACPI]: Generic affinity found ', 0aH, 00H
	ORG $+7
$SG3488	DB	'[ACPI]: GICC affinity found ', 0aH, 00H
	ORG $+2
$SG3490	DB	'[ACPI]: GIC ITS Affinity found ', 0aH, 00H
	ORG $+7
$SG3492	DB	'[ACPI]: X2APIC CPU Affinity found ', 0aH, 00H
	ORG $+4
$SG3494	DB	'[ACPI]: Srat type reserved ', 0aH, 00H
	ORG $+3
$SG3504	DB	'SLIT', 00H
	ORG $+3
$SG3505	DB	'SLIT', 00H
	ORG $+3
$SG3506	DB	'[ACPI]: Slit table found ', 0aH, 00H
	ORG $+1
$SG3509	DB	'MCFG', 00H
	ORG $+3
$SG3510	DB	'MCFG', 00H
...
$SG3531	DB	'HPET', 00H
	ORG $+7
$SG3528	DB	'PCIe Start bus num -> %d, End bus num -> %d, base addres'
	DB	's-> %x', 0aH, 00H
$SG3532	DB	'HPET', 00H
	ORG $+3
$SG3533	DB	'[ACPI]: HPET table found', 0aH, 00H
	ORG $+2
$SG3536	DB	'MCHI', 00H
	ORG $+3
$SG3537	DB	'MCHI', 00H
	ORG $+7
$SG3538	DB	'[ACPI]: Management Controller Host Interface Table', 0aH
	DB	00H
	ORG $+4
$SG3543	DB	'[ACPI]: Dsdt found -> %x', 0aH, 00H
	ORG $+6
$SG3544	DB	'[ACPI]: Sci Interrupt -> %d', 0aH, 00H
	ORG $+3
$SG3547	DB	'S5Block found', 0aH, 00H
	ORG $+1
$SG3550	DB	'[ACPI]: SLP_typA -> %x, SLP_typB -> %x', 0aH, 00H
$SG3571	DB	'[ACPI]: Madt entry -> LAPIC id -> %d, address -> %x', 0aH
	DB	00H
	ORG $+3
$SG3576	DB	'[ACPI]: Madt entry -> I/O APIC address -> %x, GSI -> %d', 0aH
	DB	00H
	ORG $+7
$SG3580	DB	'[ACPI]: Interrupt Source Override, GSI -> %d, SRC -> %d', 0aH
	DB	00H
	ORG $+7
$SG3591	DB	'[ACPI]: Reset Address -> %x, Reset value -> %x', 0aH, 00H
$SG3595	DB	'Shutdown step1 complete', 0aH, 00H
	ORG $+7
$SG3597	DB	'[ACPI] pm1bCtrlBlock -> %x', 0aH, 00H
	ORG $+4
$SG3598	DB	0aH, 'Shutdown step2 complete', 0aH, 00H
	ORG $+6
$SG3599	DB	'[ACPI]: Shutdown failed', 0aH, 00H
CONST	ENDS
