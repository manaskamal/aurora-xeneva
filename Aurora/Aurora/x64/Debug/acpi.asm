...
_BSS	ENDS
CONST	SEGMENT
$SG3375	DB	'[ACPI]: data structures are incomplete', 0aH, 00H
$SG3378	DB	'[ACPI]: Already enabled', 0aH, 00H
	ORG $+7
$SG3380	DB	'PM1aCTRLBlock -> %x', 0aH, 00H
	ORG $+3
$SG3382	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3384	DB	'[ACPI]: Verifying pm1bCtrlBlock ', 0aH, 00H
	ORG $+6
$SG3387	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3392	DB	'[ACPI]: Fadt interrupt fired', 0aH, 00H
	ORG $+2
$SG3412	DB	'FACP', 00H
	ORG $+3
$SG3413	DB	'FACP', 00H
	ORG $+3
$SG3415	DB	'[ACPI]: Fadt table found', 0aH, 00H
	ORG $+2
$SG3418	DB	'CIPA', 00H
	ORG $+3
$SG3419	DB	'APIC', 00H
	ORG $+7
$SG3421	DB	'[ACPI]: Madt table found', 0aH, 00H
	ORG $+2
$SG3424	DB	'SRAT', 00H
	ORG $+3
$SG3425	DB	'SRAT', 00H
	ORG $+7
$SG3426	DB	'[ACPI]: Srat table found', 0aH, 00H
	ORG $+6
$SG3429	DB	'[ACPI]: Srat -> %d length -> %d', 0aH, 00H
	ORG $+7
$SG3446	DB	'[ACPI]: Srat memory affinity found ', 0aH, 00H
	ORG $+3
$SG3449	DB	'Mem start -> %x ', 0aH, 00H
	ORG $+6
$SG3450	DB	'Mem end -> %x ', 0aH, 00H
$SG3451	DB	'Mem Length -> %d MB ', 0aH, 00H
	ORG $+2
$SG3452	DB	'Numa Domain -> %d ', 0aH, 00H
	ORG $+4
$SG3453	DB	'Mem LLength -> %d', 0aH, 00H
	ORG $+5
$SG3455	DB	'[ACPI]: Srat cpu affinity found ', 0aH, 00H
	ORG $+6
$SG3457	DB	'[ACPI]: Generic affinity found ', 0aH, 00H
	ORG $+7
$SG3459	DB	'[ACPI]: GICC affinity found ', 0aH, 00H
	ORG $+2
$SG3461	DB	'[ACPI]: GIC ITS Affinity found ', 0aH, 00H
	ORG $+7
$SG3463	DB	'[ACPI]: X2APIC CPU Affinity found ', 0aH, 00H
	ORG $+4
$SG3465	DB	'[ACPI]: Srat type reserved ', 0aH, 00H
	ORG $+3
$SG3475	DB	'SLIT', 00H
	ORG $+3
$SG3476	DB	'SLIT', 00H
	ORG $+3
$SG3477	DB	'[ACPI]: Slit table found ', 0aH, 00H
	ORG $+1
$SG3480	DB	'MCFG', 00H
	ORG $+3
$SG3481	DB	'MCFG', 00H
...
$SG3502	DB	'HPET', 00H
	ORG $+7
$SG3499	DB	'PCIe Start bus num -> %d, End bus num -> %d, base addres'
	DB	's-> %x', 0aH, 00H
$SG3503	DB	'HPET', 00H
	ORG $+3
$SG3504	DB	'[ACPI]: HPET table found', 0aH, 00H
	ORG $+2
$SG3507	DB	'MCHI', 00H
	ORG $+3
$SG3508	DB	'MCHI', 00H
	ORG $+7
$SG3509	DB	'[ACPI]: Management Controller Host Interface Table', 0aH
	DB	00H
	ORG $+4
$SG3514	DB	'[ACPI]: Dsdt found -> %x', 0aH, 00H
	ORG $+6
$SG3515	DB	'[ACPI]: Sci Interrupt -> %d', 0aH, 00H
	ORG $+3
$SG3518	DB	'S5Block found', 0aH, 00H
	ORG $+1
$SG3521	DB	'[ACPI]: SLP_typA -> %x, SLP_typB -> %x', 0aH, 00H
$SG3542	DB	'[ACPI]: Madt entry -> LAPIC id -> %d, address -> %x', 0aH
	DB	00H
	ORG $+3
$SG3547	DB	'[ACPI]: Madt entry -> I/O APIC address -> %x, GSI -> %d', 0aH
	DB	00H
	ORG $+7
$SG3551	DB	'[ACPI]: Interrupt Source Override, GSI -> %d, SRC -> %d', 0aH
	DB	00H
	ORG $+7
$SG3562	DB	'[ACPI]: Reset Address -> %x, Reset value -> %x', 0aH, 00H
$SG3566	DB	'Shutdown step1 complete', 0aH, 00H
	ORG $+7
$SG3568	DB	'[ACPI] pm1bCtrlBlock -> %x', 0aH, 00H
	ORG $+4
$SG3569	DB	0aH, 'Shutdown step2 complete', 0aH, 00H
	ORG $+6
$SG3570	DB	'[ACPI]: Shutdown failed', 0aH, 00H
CONST	ENDS
