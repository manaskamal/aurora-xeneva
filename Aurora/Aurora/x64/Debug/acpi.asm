...
_BSS	ENDS
CONST	SEGMENT
$SG3544	DB	'[ACPI]: data structures are incomplete', 0aH, 00H
$SG3547	DB	'[ACPI]: Already enabled', 0aH, 00H
	ORG $+7
$SG3549	DB	'PM1aCTRLBlock -> %x', 0aH, 00H
	ORG $+3
$SG3551	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3553	DB	'[ACPI]: Verifying pm1bCtrlBlock ', 0aH, 00H
	ORG $+6
$SG3556	DB	'[ACPI]: Enabled successfully', 0aH, 00H
	ORG $+2
$SG3561	DB	'[ACPI]: Fadt interrupt fired', 0aH, 00H
	ORG $+2
$SG3581	DB	'FACP', 00H
	ORG $+3
$SG3582	DB	'FACP', 00H
	ORG $+3
$SG3584	DB	'[ACPI]: Fadt table found', 0aH, 00H
	ORG $+2
$SG3587	DB	'CIPA', 00H
	ORG $+3
$SG3588	DB	'APIC', 00H
	ORG $+7
$SG3590	DB	'[ACPI]: Madt table found', 0aH, 00H
	ORG $+2
$SG3593	DB	'SRAT', 00H
	ORG $+3
$SG3594	DB	'SRAT', 00H
	ORG $+7
$SG3595	DB	'[ACPI]: Srat table found', 0aH, 00H
	ORG $+6
$SG3598	DB	'[ACPI]: Srat -> %d length -> %d', 0aH, 00H
	ORG $+7
$SG3619	DB	'[ACPI]: Generic affinity found ', 0aH, 00H
	ORG $+7
$SG3621	DB	'[ACPI]: GICC affinity found ', 0aH, 00H
	ORG $+2
$SG3623	DB	'[ACPI]: GIC ITS Affinity found ', 0aH, 00H
	ORG $+7
$SG3625	DB	'[ACPI]: X2APIC CPU Affinity found ', 0aH, 00H
	ORG $+4
$SG3627	DB	'[ACPI]: Srat type reserved ', 0aH, 00H
	ORG $+3
$SG3637	DB	'SLIT', 00H
	ORG $+3
$SG3638	DB	'SLIT', 00H
	ORG $+3
$SG3639	DB	'[ACPI]: Slit table found ', 0aH, 00H
	ORG $+1
$SG3642	DB	'MCFG', 00H
	ORG $+3
$SG3643	DB	'MCFG', 00H
	ORG $+7
$SG3653	DB	'PCIe Segment -> %d ', 0aH, 00H
	ORG $+3
$SG3652	DB	'PCIe Start bus num -> %d, End bus num -> %d, base addres'
	DB	's-> %x', 0aH, 00H
$SG3656	DB	'HPET', 00H
	ORG $+3
$SG3657	DB	'HPET', 00H
	ORG $+3
$SG3658	DB	'[ACPI]: HPET table found', 0aH, 00H
	ORG $+2
$SG3661	DB	'MCHI', 00H
	ORG $+3
$SG3662	DB	'MCHI', 00H
	ORG $+7
$SG3663	DB	'[ACPI]: Management Controller Host Interface Table', 0aH
	DB	00H
	ORG $+4
$SG3668	DB	'[ACPI]: Dsdt found -> %x', 0aH, 00H
	ORG $+6
$SG3669	DB	'[ACPI]: Sci Interrupt -> %d', 0aH, 00H
	ORG $+3
$SG3672	DB	'S5Block found', 0aH, 00H
	ORG $+1
$SG3675	DB	'[ACPI]: SLP_typA -> %x, SLP_typB -> %x', 0aH, 00H
$SG3696	DB	'[ACPI]: Madt entry -> LAPIC id -> %d, address -> %x', 0aH
	DB	00H
	ORG $+3
$SG3701	DB	'[ACPI]: Madt entry -> I/O APIC address -> %x, GSI -> %d', 0aH
	DB	00H
	ORG $+7
$SG3705	DB	'[ACPI]: Interrupt Source Override, GSI -> %d, SRC -> %d', 0aH
	DB	00H
	ORG $+7
$SG3716	DB	'[ACPI]: Reset Address -> %x, Reset value -> %x', 0aH, 00H
$SG3720	DB	'Shutdown step1 complete', 0aH, 00H
	ORG $+7
$SG3722	DB	'[ACPI] pm1bCtrlBlock -> %x', 0aH, 00H
	ORG $+4
$SG3723	DB	0aH, 'Shutdown step2 complete', 0aH, 00H
	ORG $+6
$SG3724	DB	'[ACPI]: Shutdown failed', 0aH, 00H
CONST	ENDS
