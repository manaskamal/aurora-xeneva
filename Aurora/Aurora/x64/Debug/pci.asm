...
_BSS	ENDS
CONST	SEGMENT
$SG3858	DB	'MSI-X found for this device', 0aH, 00H
	ORG $+3
$SG3860	DB	'MSI found for this device', 0aH, 00H
	ORG $+5
$SG3865	DB	'MSI-DATA -> %x', 0aH, 00H
$SG3870	DB	'MSG Control -> %x', 0aH, 00H
	ORG $+5
$SG3877	DB	'MSI 64BIT Capable', 0aH, 00H
	ORG $+5
$SG3879	DB	'MSI Mask Capable', 0aH, 00H
	ORG $+6
$SG3880	DB	'MSI interrupt for this device enabled msi reg -> %x', 0aH
	DB	00H
	ORG $+3
$SG3918	DB	'Device found -> %d, vendor -> %d ', 0aH, 00H
CONST	ENDS
