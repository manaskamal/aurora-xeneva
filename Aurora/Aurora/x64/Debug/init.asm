...
_BSS	ENDS
CONST	SEGMENT
$SG5672	DB	'Scheduler Initialized', 0aH, 00H
	ORG $+1
$SG5674	DB	'shell', 00H
	ORG $+2
$SG5675	DB	'/init.exe', 00H
	ORG $+2
$SG5676	DB	'priwm', 00H
	ORG $+6
$SG5677	DB	'/priwm.exe', 00H
CONST	ENDS
