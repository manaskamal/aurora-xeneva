...
_BSS	ENDS
CONST	SEGMENT
$SG5477	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5483	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5494	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5500	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5511	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5518	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5519	DB	'returning', 0aH, 00H
	ORG $+5
$SG5529	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
