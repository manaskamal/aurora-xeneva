...
_BSS	ENDS
CONST	SEGMENT
$SG5508	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5514	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5525	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5531	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5542	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5549	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5550	DB	'returning', 0aH, 00H
	ORG $+5
$SG5560	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
