...
_BSS	ENDS
CONST	SEGMENT
$SG5511	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5517	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5528	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5534	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5545	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5552	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5553	DB	'returning', 0aH, 00H
	ORG $+5
$SG5563	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
