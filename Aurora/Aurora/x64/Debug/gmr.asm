...
_BSS	ENDS
CONST	SEGMENT
$SG5534	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5540	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5551	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5557	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5568	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5575	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5576	DB	'returning', 0aH, 00H
	ORG $+5
$SG5586	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
