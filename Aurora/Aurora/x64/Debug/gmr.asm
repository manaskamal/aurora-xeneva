...
_BSS	ENDS
CONST	SEGMENT
$SG5471	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5477	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5488	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5494	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5505	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5512	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5513	DB	'returning', 0aH, 00H
	ORG $+5
$SG5523	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
