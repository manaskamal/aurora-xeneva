...
_BSS	ENDS
CONST	SEGMENT
$SG5528	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5534	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5545	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5551	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5562	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5569	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5570	DB	'returning', 0aH, 00H
	ORG $+5
$SG5580	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
