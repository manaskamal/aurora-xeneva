...
_BSS	ENDS
CONST	SEGMENT
$SG5507	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5513	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5524	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5530	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5541	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5548	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5549	DB	'returning', 0aH, 00H
	ORG $+5
$SG5559	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
