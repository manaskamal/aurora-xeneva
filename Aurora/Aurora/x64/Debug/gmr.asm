...
_BSS	ENDS
CONST	SEGMENT
$SG5504	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5510	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5521	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5527	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5538	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5545	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5546	DB	'returning', 0aH, 00H
	ORG $+5
$SG5556	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
