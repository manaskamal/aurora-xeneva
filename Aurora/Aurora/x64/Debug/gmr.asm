...
_BSS	ENDS
CONST	SEGMENT
$SG5415	DB	'Virtual device does not have GMR support', 0aH, 00H
	ORG $+6
$SG5421	DB	'Virtual device does not have GMR v2 support', 0aH, 00H
	ORG $+3
$SG5432	DB	'Desc Array -> %x', 0aH, 00H
	ORG $+6
$SG5438	DB	'First page -> %x', 0aH, 00H
	ORG $+6
$SG5449	DB	'REGISTER WRITTEN', 0aH, 00H
	ORG $+6
$SG5456	DB	'PPN iiiii -> %x', 0aH, 00H
	ORG $+7
$SG5457	DB	'returning', 0aH, 00H
	ORG $+5
$SG5467	DB	'Desc allocated %x', 0aH, 00H
CONST	ENDS
