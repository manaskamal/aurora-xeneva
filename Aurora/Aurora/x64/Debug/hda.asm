...
_BSS	ENDS
CONST	SEGMENT
$SG3392	DB	'HD-Audio Interrupt fired++', 0aH, 00H
	ORG $+4
$SG3417	DB	'HD Audio: No supported RIRB size !!', 0aH, 00H
	ORG $+3
$SG3482	DB	'Initializing output ->codec -> %d, nid -> %d', 0aH, 00H
	ORG $+2
$SG3499	DB	'output', 00H
	ORG $+1
$SG3501	DB	'input', 00H
	ORG $+2
$SG3503	DB	'mixer', 00H
	ORG $+2
$SG3505	DB	'selector', 00H
	ORG $+3
$SG3509	DB	'power', 00H
	ORG $+6
$SG3507	DB	'pin complex', 00H
	ORG $+4
$SG3511	DB	'volume knob', 00H
	ORG $+4
$SG3513	DB	'beep generator', 00H
	ORG $+1
$SG3515	DB	'vendor defined', 00H
	ORG $+1
$SG3517	DB	'unknown', 00H
$SG3529	DB	'[HD-Audio]:Widget type Output in codec -> %d at node -> '
	DB	'%d', 0aH, 00H
	ORG $+4
$SG3542	DB	'[HD_Audio]: Num Function Group -> %d, fg_start -> %d', 0aH
	DB	00H
	ORG $+2
$SG3544	DB	'[HD-Audio]:Widget device id -> %x, vendor id -> %x', 0aH
	DB	00H
	ORG $+4
$SG3546	DB	'[HD-Audio]:Widget version -> %d.%d, r0%d', 0aH, 00H
	ORG $+6
$SG3568	DB	'Unable to put HD-Audio in reset mode', 0aH, 00H
	ORG $+2
$SG3583	DB	'HD-Audio device stuck in reset', 0aH, 00H
$SG3596	DB	'No HD-Audio was found', 0aH, 00H
	ORG $+1
$SG3598	DB	'HD Audio found vendor -> %x, device -> %x', 0aH, 00H
	ORG $+5
$SG3599	DB	'HD-Audio interrupt line -> %d', 0aH, 00H
	ORG $+1
$SG3605	DB	'HD-Audio 64-OK', 0aH, 00H
$SG3612	DB	'IHD Audio Initialized successfully', 0aH, 00H
CONST	ENDS
...
; 462  : 	_aud_outb_(CORBCTL, 0);

	xor	edx, edx
	mov	ecx, 76					; 0000004cH
	call	?_aud_outb_@@YAXHE@Z			; _aud_outb_

; 463  : 	_aud_outb_(RIRBCTL, 0);

	xor	edx, edx
	mov	ecx, 92					; 0000005cH
	call	?_aud_outb_@@YAXHE@Z			; _aud_outb_

; 464  : 	//_aud_outw_(RIRBWP, 0);
; 465  : 
; 466  : 	_aud_outl_ (DPIBLBASE, 0x0);

	xor	edx, edx
	mov	ecx, 112				; 00000070H
	call	?_aud_outl_@@YAXHI@Z			; _aud_outl_

; 467  : 	_aud_outl_ (DPIBUBASE, 0x0);
...
; 480  : 		printf ("Unable to put HD-Audio in reset mode\n");
...
; 488  : 	_aud_outl_ (GCTL, gctl | 0x00000001);
...
; 491  : 	do {
; 492  : 		gctl = _aud_inl_(GCTL);

	mov	ecx, 8
	call	?_aud_inl_@@YAIH@Z			; _aud_inl_
	mov	DWORD PTR gctl$[rsp], eax

; 493  : 		if (gctl & 0x00000001)
...
; 500  : 		printf ("HD-Audio device stuck in reset\n");
...
; 506  : 		//printf ("ICIS ICB bit is clear\n");
; 507  : 	}
; 508  : 	
; 509  : 	_ihd_audio.immediate_use = false;

	mov	BYTE PTR ?_ihd_audio@@3U_hd_audio_@@A+32, 0

; 510  :     _aud_outw_(WAKEEN, 0x01);

	mov	dx, 1
	mov	ecx, 12
	call	?_aud_outw_@@YAXHG@Z			; _aud_outw_

; 511  : 	for (int i = 0; i < 10000; i++)
...
; 411  : static void codec_enumerate_widgets(int codec) {
...
; 412  : 
; 413  : 	uint32_t param;
; 414  : 	int num_fg, num_widgets;
; 415  : 	int fg_start, widgets_start;
; 416  : 	int i, j;
; 417  : 
; 418  : 
; 419  : 	param = codec_query (codec, 0, VERB_GET_PARAMETER | PARAM_NODE_COUNT);
...
; 423  : 
; 424  : 
; 425  : 	printf ("[HD_Audio]: Num Function Group -> %d, fg_start -> %d\n", num_fg, fg_start);
...
; 426  : 
; 427  : 	uint32_t vendor_id = codec_query (codec, 0, VERB_GET_PARAMETER | PARAM_VENDOR_ID);
...
; 428  : 	printf ("[HD-Audio]:Widget device id -> %x, vendor id -> %x\n", vendor_id , (vendor_id >> 16 ));
...
; 429  : 	
; 430  : 	uint32_t rev_id = codec_query (codec, 0, VERB_GET_PARAMETER | PARAM_REV_ID);
...
; 431  : 	printf ("[HD-Audio]:Widget version -> %d.%d, r0%d\n", rev_id>>20, rev_id>>16, rev_id>>8);
...
; 435  : 		param = codec_query (codec, fg_start + i, 
; 436  : 			VERB_GET_PARAMETER | PARAM_NODE_COUNT);
...
; 437  : 
; 438  : 		num_widgets = param & 0xff;

	mov	eax, DWORD PTR param$[rsp]
	and	eax, 255				; 000000ffH
	mov	DWORD PTR num_widgets$[rsp], eax

; 439  : 		widgets_start = (param >> 16) & 0xff;
...
; 440  : 
; 441  : 
; 442  : 		param = codec_query (codec, fg_start + i, VERB_GET_PARAMETER | PARAM_FN_GROUP_TYPE);
...
; 446  : 
; 447  : 		for (int i = 0; i < num_widgets; i++) {
...
; 448  : 			widget_init (codec, widgets_start + i);
...
; 322  : void widget_init (int codec, int nid) {
...
; 323  : 
; 324  : 	uint32_t widget_cap;
; 325  : 	uint32_t type;
; 326  : 	uint32_t amp_cap;
; 327  : 	uint32_t eapd_btl;
; 328  : 
; 329  : 	//! send a command for audio widget capabilites
; 330  : 	widget_cap = codec_query (codec, nid, VERB_GET_PARAMETER | PARAM_AUDIO_WID_CAP);
...
; 334  : 	}
; 335  : 
; 336  : 	type = (widget_cap & WIDGET_CAP_TYPE_MASK) >> WIDGET_CAP_TYPE_SHIFT;
...
; 337  : 	amp_cap = codec_query (codec, nid, VERB_GET_PARAMETER | PARAM_OUT_AMP_CAP);
...
; 338  : 	eapd_btl = codec_query (codec, nid, VERB_GET_EAPD_BTL);
...
; 346  : 	case 0:  s = "output"; break;

	lea	rax, OFFSET FLAT:$SG3499
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN17@widget_ini:

; 347  : 	case 1:  s = "input"; break;

	lea	rax, OFFSET FLAT:$SG3501
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN16@widget_ini:

; 348  : 	case 2:  s = "mixer"; break;

	lea	rax, OFFSET FLAT:$SG3503
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN15@widget_ini:

; 349  : 	case 3:  s = "selector"; break;

	lea	rax, OFFSET FLAT:$SG3505
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN14@widget_ini:

; 350  : 	case 4:  s = "pin complex"; break;

	lea	rax, OFFSET FLAT:$SG3507
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN13@widget_ini:

; 351  : 	case 5:  s = "power"; break;

	lea	rax, OFFSET FLAT:$SG3509
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN12@widget_ini:

; 352  : 	case 6:  s = "volume knob"; break;

	lea	rax, OFFSET FLAT:$SG3511
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN11@widget_ini:

; 353  : 	case 7:  s = "beep generator"; break;

	lea	rax, OFFSET FLAT:$SG3513
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN10@widget_ini:

; 354  : 	case 16: s = "vendor defined"; break;

	lea	rax, OFFSET FLAT:$SG3515
	mov	QWORD PTR s$[rsp], rax
	jmp	SHORT $LN19@widget_ini
$LN9@widget_ini:

; 355  : 	default: s = "unknown"; break;

	lea	rax, OFFSET FLAT:$SG3517
	mov	QWORD PTR s$[rsp], rax
$LN19@widget_ini:
...
; 357  : 	}
; 358  : 
; 359  : 	amp_gain = codec_query(codec, nid, VERB_GET_AMP_GAIN_MUTE | 0x8000) << 8;
...
; 360  : 	amp_gain |= codec_query(codec, nid, VERB_GET_AMP_GAIN_MUTE | 0xa000);
...
; 361  : 
; 362  : 	/*printf ("[HD-Audio]: widget %s at node %d; \n",
; 363  : 		s, nid);*/
; 364  : 
; 365  : 	switch (type) {
...
; 366  : 	case WIDGET_PIN:
; 367  : 		{
; 368  : 			uint32_t pin_cap, ctl;
; 369  : 			uint32_t conf = codec_query(codec, nid, VERB_GET_CONFIG_DEFAULT);
...
; 370  : 			//printf ("pin config: %x\n", conf);
; 371  : 
; 372  : 			pin_cap = codec_query (codec, nid, VERB_GET_PARAMETER | PARAM_PIN_CAP);
...
; 373  : 
; 374  : 			if ((pin_cap & PIN_CAP_OUTPUT) == 0) {
...
; 376  : 			}
; 377  : 
; 378  : 			ctl = codec_query (codec, nid, VERB_GET_PIN_CONTROL);
...
; 379  : 			//printf ("ctl: %x\n", ctl);
; 380  : 
; 381  : 			ctl |= PIN_CTL_ENABLE_OUTPUT;

	mov	eax, DWORD PTR ctl$1[rsp]
	or	eax, 64					; 00000040H
	mov	DWORD PTR ctl$1[rsp], eax

; 382  : 			codec_query(codec, nid, VERB_SET_PIN_CONTROL | ctl);
...
; 383  : 			codec_query(codec, nid, VERB_SET_EAPD_BTL | eapd_btl | 0x2);
...
; 385  : 		}
; 386  : 
; 387  : 	case WIDGET_OUTPUT:
; 388  : 		{
; 389  : 			if (!_ihd_audio.output->nid) {
...
; 390  : 				_ihd_audio.output->codec = codec;

	mov	rax, QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+33
	movzx	ecx, BYTE PTR codec$[rsp]
	mov	BYTE PTR [rax], cl

; 391  : 				_ihd_audio.output->nid = nid;

	mov	rax, QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+33
	movzx	ecx, WORD PTR nid$[rsp]
	mov	WORD PTR [rax+2], cx

; 392  : 				_ihd_audio.output->amp_gain_steps = (amp_cap >> 8) & 0x7f;
...
; 393  : 			}
; 394  : 			printf ("[HD-Audio]:Widget type Output in codec -> %d at node -> %d\n", codec, nid);
...
; 296  : void init_output () {

$LN3:
	sub	rsp, 56					; 00000038H

; 297  : 	uint32_t stream_format = 0;

	mov	DWORD PTR stream_format$[rsp], 0

; 298  : 	stream_format |= (1<<0);

	mov	eax, DWORD PTR stream_format$[rsp]
	or	eax, 1
	mov	DWORD PTR stream_format$[rsp], eax

; 299  : 	stream_format |= (1<<4);

	mov	eax, DWORD PTR stream_format$[rsp]
	or	eax, 16
	mov	DWORD PTR stream_format$[rsp], eax

; 300  : 	codec_query (_ihd_audio.output->codec, _ihd_audio.output->nid, 
; 301  : 		VERB_SET_STREAM_CHANNEL | stream_format);   //0x10
...
; 302  : 
; 303  : 	_ihd_audio.output->sample_rate = 0;

	mov	rax, QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+33
	mov	DWORD PTR [rax+4], 0

; 304  : 	_ihd_audio.output->num_channels = 2;

	mov	rax, QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+33
	mov	DWORD PTR [rax+12], 2

; 305  : 
; 306  : 	uint16_t format = (4<<4) | _ihd_audio.output->sample_rate | 
; 307  : 		(_ihd_audio.output->num_channels - 1);
...
; 308  : 
; 309  : 	codec_query (_ihd_audio.output->codec, _ihd_audio.output->nid, VERB_SET_FORMAT | format);
...
; 278  : void hda_set_volume (uint8_t volume) {
...
; 285  : 		/* scale to num steps */
; 286  : 		volume = volume * _ihd_audio.output->amp_gain_steps / 255;
...
; 287  : 	}
; 288  : 
; 289  : 	codec_query (_ihd_audio.output->codec, _ihd_audio.output->nid, VERB_SET_AMP_GAIN_MUTE | meta | volume);
...
; 251  : void hda_start_stream () {

$LN9:
	sub	rsp, 88					; 00000058H

; 252  : 	_aud_outb_ (REG_O0_CTLU,0x10);

	mov	dl, 16
	mov	ecx, 258				; 00000102H
	call	?_aud_outb_@@YAXHE@Z			; _aud_outb_

; 253  : 	_aud_outl_ (REG_O0_CBL, 4 * 0x100000);

	mov	edx, 4194304				; 00400000H
	mov	ecx, 264				; 00000108H
	call	?_aud_outl_@@YAXHI@Z			; _aud_outl_

; 254  : 	_aud_outw_(REG_O0_STLVI, 4 - 1);
...
; 255  : 
; 256  : 	for (int i = 0; i < 0x400000 / 4096; i++)
...
; 257  : 		map_page ((uint64_t)pmmngr_alloc(), 0x0000000080000000 + i * 4096);
...
; 262  : 	ihda_bdl_entry *bdl = (ihda_bdl_entry*)bdl_base;
...
; 265  : 		bdl[i].paddr = (uint64_t)pmmngr_alloc();
...
; 269  : 
; 270  : 	uint64_t dma_pos = (uint64_t)pmmngr_alloc();

	call	?pmmngr_alloc@@YAPEAXXZ			; pmmngr_alloc
	mov	QWORD PTR dma_pos$[rsp], rax

; 271  : 	_aud_outl_(DPIBLBASE, dma_pos | 0x1);
...
; 272  : 	_aud_outl_(DPIBUBASE, dma_pos >> 32);
...
; 524  : void hda_initialize () {

$LN10:
	sub	rsp, 344				; 00000158H

; 525  : 	pci_device_info pci_dev;
; 526  : 	int bus, dev, func;
; 527  : 
; 528  : 	if (!pci_find_device_class (0x04, 0x03, &pci_dev, &bus, &dev, &func)){
...
; 529  : 		printf ("No HD-Audio was found\n");
...
; 540  : 
; 541  : 
; 542  : 	bool pci_status = pci_alloc_msi (func, dev, bus, hda_handler);
...
; 544  : 		//! fall to legacy interrupt handling mode
; 545  : 		//interrupt_set (pci_dev.device.nonBridge.interruptLine, hda_handler, pci_dev.device.nonBridge.interruptLine);
; 546  : 	}
; 547  : 
; 548  : 	_ihd_audio.mmio = pci_dev.device.nonBridge.baseAddress[0] & ~3;
...
; 549  : 	_ihd_audio.corb = (uint32_t*)pmmngr_alloc(); //for 256 entries only 1 kb will be used

	call	?pmmngr_alloc@@YAPEAXXZ			; pmmngr_alloc
	mov	QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+8, rax

; 550  : 	_ihd_audio.rirb = (uint64_t*)pmmngr_alloc(); //(ring_address + 1024);

	call	?pmmngr_alloc@@YAPEAXXZ			; pmmngr_alloc
	mov	QWORD PTR ?_ihd_audio@@3U_hd_audio_@@A+16, rax

; 551  : 	memset (_ihd_audio.corb, 0, 4096);
...
; 552  : 	memset (_ihd_audio.rirb, 0, 4096);
...
; 559  :     
; 560  :    
; 561  : 	uint16_t statests = _aud_inw_ (STATESTS);

	mov	ecx, 14
	call	?_aud_inw_@@YAGH@Z			; _aud_inw_
	mov	WORD PTR statests$[rsp], ax

; 562  : 	for (int i = 0; i < 15; i++) {
...
; 573  :    
; 574  : 	printf ("IHD Audio Initialized successfully\n");
