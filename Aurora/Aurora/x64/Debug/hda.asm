...
_BSS	ENDS
CONST	SEGMENT
$SG3397	DB	'HD-Audio Interrupt fired++', 0aH, 00H
	ORG $+4
$SG3422	DB	'HD Audio: No supported RIRB size !!', 0aH, 00H
	ORG $+3
$SG3487	DB	'Initializing output ->codec -> %d, nid -> %d', 0aH, 00H
	ORG $+2
$SG3504	DB	'output', 00H
	ORG $+1
$SG3506	DB	'input', 00H
	ORG $+2
$SG3508	DB	'mixer', 00H
	ORG $+2
$SG3510	DB	'selector', 00H
	ORG $+3
$SG3514	DB	'power', 00H
	ORG $+6
$SG3512	DB	'pin complex', 00H
	ORG $+4
$SG3516	DB	'volume knob', 00H
	ORG $+4
$SG3518	DB	'beep generator', 00H
	ORG $+1
$SG3520	DB	'vendor defined', 00H
	ORG $+1
$SG3522	DB	'unknown', 00H
$SG3534	DB	'[HD-Audio]:Widget type Output in codec -> %d at node -> '
	DB	'%d', 0aH, 00H
	ORG $+4
$SG3547	DB	'[HD_Audio]: Num Function Group -> %d, fg_start -> %d', 0aH
	DB	00H
	ORG $+2
$SG3549	DB	'[HD-Audio]:Widget device id -> %x, vendor id -> %x', 0aH
	DB	00H
	ORG $+4
$SG3551	DB	'[HD-Audio]:Widget version -> %d.%d, r0%d', 0aH, 00H
	ORG $+6
$SG3573	DB	'Unable to put HD-Audio in reset mode', 0aH, 00H
	ORG $+2
$SG3588	DB	'HD-Audio device stuck in reset', 0aH, 00H
$SG3601	DB	'No HD-Audio was found', 0aH, 00H
	ORG $+1
$SG3603	DB	'HD Audio found vendor -> %x, device -> %x', 0aH, 00H
	ORG $+5
$SG3604	DB	'HD-Audio interrupt line -> %d', 0aH, 00H
	ORG $+1
$SG3610	DB	'HD-Audio 64-OK', 0aH, 00H
$SG3617	DB	'IHD Audio Initialized successfully', 0aH, 00H
CONST	ENDS
