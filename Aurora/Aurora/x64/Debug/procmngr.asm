...
; 43   : void procmngr_create_process (procmngr_queue *queue) {

$LN3:
	mov	QWORD PTR [rsp+8], rcx
	sub	rsp, 40					; 00000028H

; 44   : 	create_process (queue->path,queue->name,1);
...
; 48   : void procmngr_wakeup () {

$LN5:
	sub	rsp, 56					; 00000038H

; 49   : 	thread_t *proc_thr = (thread_t*)thread_iterate_block_list (2);
...
; 59   : void procmngr_start () {

$LN9:
	sub	rsp, 56					; 00000038H
$LN6@procmngr_s:

; 60   : 	procmngr_queue *queue;
; 61   : 	while (1) {
...
; 62   : 		if (process_count > 0) {

	cmp	DWORD PTR process_count, 0
	jle	SHORT $LN4@procmngr_s

; 63   : 			for (int i = 0; i < process_count; i++) {
...
; 70   : 		block_thread(get_current_thread());
...
; 30   : procmngr_queue* procmngr_get_process () {

$LN4:
	sub	rsp, 56					; 00000038H

; 31   : 	procmngr_queue *temp = NULL;
