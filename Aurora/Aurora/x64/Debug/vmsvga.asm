...
_BSS	ENDS
CONST	SEGMENT
$SG5803	DB	'No VMware SVGA device found', 0aH, 00H
	ORG $+3
$SG5813	DB	'[VMware SVGA]: negotiating SVGA device version!', 0aH, 00H
	ORG $+7
$SG5817	DB	'[VMware SVGA]: FIFO size is very small, probably incorre'
	DB	'ct', 0aH, 00H
$SG6123	DB	'svga', 00H
	ORG $+7
$SG5815	DB	'[VMware SVGA]: FrameBuffer size is very small, probably '
	DB	'incorrect', 0aH, 00H
	ORG $+5
$SG5821	DB	'Irq of svga -> %d', 0aH, 00H
	ORG $+5
$SG5822	DB	'SVGA initialized', 0aH, 00H
	ORG $+6
$SG5827	DB	'HW3D supported', 0aH, 00H
$SG5829	DB	'SVGA IRQMask', 0aH, 00H
	ORG $+2
$SG5834	DB	'SVGA IRQ appears to be present but broken %d', 0aH, 00H
	ORG $+2
$SG5848	DB	'[Aurora]: Actual Fifo Reserve function called', 0aH, 00H
	ORG $+1
$SG5853	DB	'[Aurora]: Fifo memory acquired', 0aH, 00H
$SG5856	DB	'[VMware SVGA]: FIFO command too large bytes', 0aH, 00H
	ORG $+3
$SG5859	DB	'[VMware SVGA]: FIFO command length not 32-bit aligned', 0aH
	DB	00H
	ORG $+1
$SG5861	DB	'[VMware SVGA]: FIFO reserve before FIFO commit', 0aH, 00H
$SG5868	DB	'[Aurora]: Stop -> %d', 0aH, 00H
	ORG $+2
$SG5870	DB	'[Aurora]: Debug Step[1]', 0aH, 00H
	ORG $+7
$SG5896	DB	'[VMware SVGA]: FIFO commit before FIFO reserve', 0aH, 00H
$SG5920	DB	'[Aurora]: Fifo Reserved function called', 0aH, 00H
	ORG $+7
$SG6077	DB	'SVGA interrupted', 0aH, 00H
	ORG $+6
$SG6080	DB	'Irq flags -> %d', 0aH, 00H
	ORG $+7
$SG6082	DB	'[VMware SVGA]: spurious SVGA IRQ', 0aH, 00H
	ORG $+6
$SG6124	DB	'/dev/svga', 00H
CONST	ENDS
