...
CONST	SEGMENT
$SG3853	DB	'Kernel Panic!! Page fault ', 0aH, 00H
	ORG $+4
$SG3854	DB	'Virtual address -> %x ', 0aH, 00H
$SG3855	DB	'RIP ->%x ', 0aH, 00H
	ORG $+5
$SG3856	DB	'Current thread -> %s ', 0aH, 00H
	ORG $+1
$SG3862	DB	'Page Fault -> %x ', 0aH, 00H
	ORG $+5
