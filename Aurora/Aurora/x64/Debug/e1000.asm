...
$SG3436	DB	'Applying memory map', 0aH, 00H
	ORG $+3
$SG3453	DB	'E1000 recevied', 0aH, 00H
$SG3461	DB	'E1000 Bytes received -> %d bytes, status 0x%x', 0aH, 00H
	ORG $+1
$SG3466	DB	'E1000 interrupt data transmit', 0aH, 00H
	ORG $+1
$SG3469	DB	'up', 00H
	ORG $+1
$SG3470	DB	'down', 00H
	ORG $+7
$SG3471	DB	'E1000 interrupt link change %s', 0aH, 00H
$SG3473	DB	'E1000 unknown interrupt', 0aH, 00H
	ORG $+7
$SG3485	DB	'E1000 RX Descriptor HI -> %x, LO -> %x', 0aH, 00H
$SG3497	DB	'E1000 TX_DESC_HI -> %x, LO -> %x', 0aH, 00H
	ORG $+6
$SG3507	DB	'CUR Tx tail -> %d', 0aH, 00H
	ORG $+5
$SG3512	DB	'TX Next tail -> %d', 0aH, 00H
	ORG $+4
$SG3517	DB	'Transmit status ->%x', 0aH, 00H
	ORG $+2
$SG3518	DB	'Transmitted', 0aH, 00H
	ORG $+3
$SG3529	DB	'E1000 New Packet received #3', 0aH, 00H
	ORG $+2
$SG3564	DB	'Intel Ethernet not found', 0aH, 00H
	ORG $+6
$SG3567	DB	'E1000 INterrupt Disabled in PCI ConfigSpace', 0aH, 00H
	ORG $+3
$SG3577	DB	'E1000 Supports MSI', 0aH, 00H
	ORG $+4
$SG3580	DB	'E1000 legacy irq -> %d, pin -> %d', 0aH, 00H
	ORG $+5
$SG3591	DB	'e1000 setup completed', 0aH, 00H
CONST	ENDS
