...
_BSS	ENDS
CONST	SEGMENT
$SG3396	DB	'EEPROM exist', 0aH, 00H
	ORG $+2
$SG3399	DB	'Applying memory map', 0aH, 00H
	ORG $+3
$SG3416	DB	'E1000 recevied', 0aH, 00H
$SG3424	DB	'E1000 Bytes received -> %d bytes, status 0x%x', 0aH, 00H
	ORG $+1
$SG3429	DB	'E1000 interrupt data transmit', 0aH, 00H
	ORG $+1
$SG3433	DB	'E1000 unknown interrupt', 0aH, 00H
	ORG $+7
$SG3447	DB	'E1000 RX Descriptor HI -> %x, LO -> %x', 0aH, 00H
$SG3461	DB	'E1000 TX_DESC_HI -> %x, LO -> %x', 0aH, 00H
	ORG $+6
$SG3471	DB	'CUR Tx tail -> %d', 0aH, 00H
	ORG $+5
$SG3476	DB	'TX Next tail -> %d', 0aH, 00H
	ORG $+4
$SG3481	DB	'Transmit status ->%x', 0aH, 00H
	ORG $+2
$SG3482	DB	'Transmitted', 0aH, 00H
	ORG $+3
$SG3493	DB	'E1000 New Packet received #3', 0aH, 00H
	ORG $+2
$SG3528	DB	'Intel Ethernet not found', 0aH, 00H
	ORG $+6
$SG3539	DB	'E1000 legacy irq -> %d, pin -> %d', 0aH, 00H
	ORG $+5
$SG3549	DB	'e1000 setup completed', 0aH, 00H
CONST	ENDS
