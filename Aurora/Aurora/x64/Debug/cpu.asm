...
_BSS	ENDS
CONST	SEGMENT
$SG3604	DB	'*** [x64_idt] x64_default_handler: Unhandled Exception *'
	DB	'** ', 0aH, 00H
	ORG $+3
$SG3664	DB	'IDT initialized', 0aH, 00H
	ORG $+7
$SG3665	DB	'Exception initialized', 0aH, 00H
	ORG $+1
$SG3666	DB	'APIC initialized', 0aH, 00H
	ORG $+6
$SG3668	DB	'EFER.SYSCALL enabled', 0aH, 00H
	ORG $+2
$SG3669	DB	'User Land Initialized', 0aH, 00H
	ORG $+1
$SG3670	DB	'System call initialized', 0aH, 00H
CONST	ENDS
