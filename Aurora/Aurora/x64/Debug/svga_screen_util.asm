...
_BSS	ENDS
CONST	SEGMENT
$SG5337	DB	'GMR Pages -> %x', 0aH, 00H
	ORG $+7
$SG5340	DB	'Tile buffer -> %x', 0aH, 00H
	ORG $+5
$SG5373	DB	'Drawing rect', 0aH, 00H
CONST	ENDS
