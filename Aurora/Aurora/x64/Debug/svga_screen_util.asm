...
_BSS	ENDS
CONST	SEGMENT
$SG5493	DB	'GMR Pages -> %x', 0aH, 00H
	ORG $+7
$SG5496	DB	'Tile buffer -> %x', 0aH, 00H
	ORG $+5
$SG5529	DB	'Drawing rect', 0aH, 00H
CONST	ENDS
