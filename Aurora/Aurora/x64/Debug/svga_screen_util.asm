...
_BSS	ENDS
CONST	SEGMENT
$SG5335	DB	'GMR Pages -> %x', 0aH, 00H
	ORG $+7
$SG5338	DB	'Tile buffer -> %x', 0aH, 00H
	ORG $+5
$SG5371	DB	'Drawing rect', 0aH, 00H
CONST	ENDS
