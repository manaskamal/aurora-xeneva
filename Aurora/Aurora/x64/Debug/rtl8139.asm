...
_BSS	ENDS
CONST	SEGMENT
$SG3339	DB	'***RTL8139: Interrupt fired ***', 0aH, 00H
	ORG $+7
$SG3342	DB	'Receive packet', 0aH, 00H
$SG3347	DB	'RTL8192 MAC:', 00H
	ORG $+3
$SG3352	DB	':%x', 00H
$SG3353	DB	0aH, 00H
	ORG $+2
$SG3369	DB	'Realtek RTL8139 Device not found', 0aH, 00H
	ORG $+6
$SG3371	DB	'Realtek RTL8139 Device found, io_addr -> %x, mem_base ->'
	DB	' %x', 0aH, 00H
	ORG $+3
$SG3376	DB	'PCI Command reg -> %x', 0aH, 00H
	ORG $+1
$SG3377	DB	'RTL8139 Bus Mastering enabled', 0aH, 00H
	ORG $+1
$SG3384	DB	'RTL8139 Irq -> %d', 0aH, 00H
CONST	ENDS
_DATA	SEGMENT
