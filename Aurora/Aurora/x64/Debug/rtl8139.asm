...
_BSS	ENDS
CONST	SEGMENT
$SG3347	DB	'***RTL8139: Interrupt fired ***', 0aH, 00H
	ORG $+7
$SG3350	DB	'Receive packet', 0aH, 00H
$SG3355	DB	'RTL8192 MAC:', 00H
	ORG $+3
$SG3360	DB	':%x', 00H
$SG3361	DB	0aH, 00H
	ORG $+2
$SG3377	DB	'Realtek RTL8139 Device not found', 0aH, 00H
	ORG $+6
$SG3379	DB	'Realtek RTL8139 Device found, io_addr -> %x, mem_base ->'
	DB	' %x', 0aH, 00H
	ORG $+3
$SG3384	DB	'PCI Command reg -> %x', 0aH, 00H
	ORG $+1
$SG3385	DB	'RTL8139 Bus Mastering enabled', 0aH, 00H
	ORG $+1
$SG3392	DB	'RTL8139 Irq -> %d', 0aH, 00H
CONST	ENDS
_DATA	SEGMENT
