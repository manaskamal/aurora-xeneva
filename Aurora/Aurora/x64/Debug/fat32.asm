...
_BSS	ENDS
CONST	SEGMENT
$SG3239	DB	'%s             %d bytes', 0aH, 00H
	ORG $+7
$SG3247	DB	'%s             %d bytes', 0aH, 00H
	ORG $+7
$SG3373	DB	'Root Dir entries scanning', 0aH, 00H
	ORG $+5
$SG3388	DB	'Other file size -> %s, dirent attrib -> %x, count ->%d', 0aH
	DB	00H
$SG3470	DB	'Empty entry found', 0aH, 00H
CONST	ENDS
