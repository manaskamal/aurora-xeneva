...
$SG3572	DB	'ttym', 00H
	ORG $+3
$SG3576	DB	'[TTY]: Master node mounted at -> %s  ', 0dH, 0aH, 00H
$SG3578	DB	'/dev/', 00H
	ORG $+2
$SG3579	DB	'ttys', 00H
	ORG $+3
$SG3583	DB	'[TTY]: Slave node mounted at %s ', 0dH, 0aH, 00H
	ORG $+5
$SG3586	DB	'Used RAM -> %d MB/ Total RAM %d MB', 0dH, 0aH, 00H
CONST	ENDS
_DATA	SEGMENT
