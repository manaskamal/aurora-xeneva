...
CONST	SEGMENT
$SG3695	DB	'Listing Files', 0aH, 00H
	ORG $+1
$SG3701	DB	'%s         %d KB ', 0aH, 00H
	ORG $+5
$SG3713	DB	'Creating directory ', 0dH, 0aH, 00H
	ORG $+2
$SG3745	DB	'FAT32: Directory created at entry-> %d ', 0dH, 0aH, 00H
	ORG $+6
$SG3759	DB	'Creating directory ', 0dH, 0aH, 00H
	ORG $+2
$SG3777	DB	'FAT32: Directory opened at entry-> %d ', 0dH, 0aH, 00H
CONST	ENDS
