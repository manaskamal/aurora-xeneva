...
CONST	SEGMENT
$SG3673	DB	'Listing Files', 0aH, 00H
	ORG $+1
$SG3679	DB	'%s         %d KB ', 0aH, 00H
	ORG $+5
$SG3691	DB	'Creating directory ', 0dH, 0aH, 00H
	ORG $+2
$SG3723	DB	'FAT32: Directory created at entry-> %d ', 0dH, 0aH, 00H
	ORG $+6
$SG3737	DB	'Creating directory ', 0dH, 0aH, 00H
	ORG $+2
$SG3755	DB	'FAT32: Directory opened at entry-> %d ', 0dH, 0aH, 00H
CONST	ENDS
