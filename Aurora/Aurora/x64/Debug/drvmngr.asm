...
_BSS	ENDS
CONST	SEGMENT
$SG3613	DB	'aurora_init_driver', 00H
	ORG $+5
$SG3615	DB	'aurora_close_driver', 00H
	ORG $+4
$SG3617	DB	'aurora_write', 00H
	ORG $+3
$SG3625	DB	'sb16', 00H
CONST	ENDS
...
; 39   : 	param->interrupt_eoi = interrupt_end;
