...
_BSS	ENDS
CONST	SEGMENT
$SG3000	DB	'master ', 00H
$SG3001	DB	'slave', 00H
	ORG $+2
$SG3002	DB	'primary', 00H
$SG3003	DB	'secondary', 00H
	ORG $+6
$SG3004	DB	'ATA: %s s has error. disabled, ', 0aH, 00H
	ORG $+7
$SG3034	DB	'[ATA]: error!, device failure!', 0aH, 00H
CONST	ENDS
