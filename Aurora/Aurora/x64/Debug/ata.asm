...
_BSS	ENDS
CONST	SEGMENT
$SG3003	DB	'master ', 00H
$SG3004	DB	'slave', 00H
	ORG $+2
$SG3005	DB	'primary', 00H
$SG3006	DB	'secondary', 00H
	ORG $+6
$SG3007	DB	'ATA: %s s has error. disabled, ', 0aH, 00H
	ORG $+7
$SG3037	DB	'[ATA]: error!, device failure!', 0aH, 00H
CONST	ENDS
