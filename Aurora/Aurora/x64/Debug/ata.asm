...
_BSS	ENDS
CONST	SEGMENT
$SG3099	DB	'master ', 00H
$SG3100	DB	'slave', 00H
	ORG $+2
$SG3101	DB	'primary', 00H
$SG3102	DB	'secondary', 00H
	ORG $+6
$SG3103	DB	'ATA: %s s has error. disabled, ', 0aH, 00H
	ORG $+7
$SG3133	DB	'[ATA]: error!, device failure!', 0aH, 00H
$SG3174	DB	'[ATA]: Read28 -- no selected io & drive', 0aH, 00H
	ORG $+7
$SG3262	DB	'[ATA]: Primary-Master Device: %s', 0aH, 00H
	ORG $+6
$SG3264	DB	'[ATA]: Primary-Master Device Size -> %d GB', 0aH, 00H
	ORG $+4
$SG3270	DB	'[ATA]: Primary-Slave Device: %s', 0aH, 00H
CONST	ENDS
