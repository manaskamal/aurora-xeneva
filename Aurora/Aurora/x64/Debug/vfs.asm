...
_BSS	ENDS
CONST	SEGMENT
$SG3503	DB	'[VFS]: Mounting filesystem to root failed, already in us'
	DB	'e', 0aH, 00H
	ORG $+5
$SG3531	DB	'[vfs]: already mounted -> %s', 0aH, 00H
	ORG $+2
$SG3573	DB	'Directory', 00H
	ORG $+2
$SG3576	DB	'File', 00H
	ORG $+7
$SG3577	DB	'%s -> %s ', 0aH, 00H
CONST	ENDS
