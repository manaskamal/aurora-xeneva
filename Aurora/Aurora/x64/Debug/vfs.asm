...
_BSS	ENDS
CONST	SEGMENT
$SG3501	DB	'[VFS]: Mounting filesystem to root failed, already in us'
	DB	'e', 0aH, 00H
	ORG $+5
$SG3529	DB	'[vfs]: already mounted -> %s', 0aH, 00H
	ORG $+2
$SG3571	DB	'Directory', 00H
	ORG $+2
$SG3574	DB	'File', 00H
	ORG $+7
$SG3575	DB	'%s -> %s ', 0aH, 00H
CONST	ENDS
