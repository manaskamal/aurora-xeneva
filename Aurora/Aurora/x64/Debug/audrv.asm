...
_BSS	ENDS
CONST	SEGMENT
$SG3743	DB	'AuDriverMain', 00H
	ORG $+3
$SG3746	DB	'AuDriverUnload', 00H
	ORG $+1
$SG3752	DB	'[aurora]: initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG3758	DB	'/audrv.cnf', 00H
CONST	ENDS
