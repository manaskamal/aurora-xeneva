...
CONST	SEGMENT
$SG3424	DB	'FAT32: Creating a file ', 0dH, 0aH, 00H
	ORG $+6
$SG3443	DB	'FAT32: file created at entry-> %d ', 0dH, 0aH, 00H
	ORG $+3
$SG3467	DB	'[FAT32]: cluster -> %d flushed to disk ', 0dH, 0aH, 00H
	ORG $+6
$SG3482	DB	'[FAT32]: Writing to file, required clusters -> %d ', 0dH
	DB	0aH, 00H
CONST	ENDS
...
; 145  : 	}
; 146  : 
; 147  : 	uint64_t* ahci_buff = (uint64_t*)pmmngr_alloc();
...
; 64   : 
; 65   : 
; 66   : 	uint64_t* buff = (uint64_t*)pmmngr_alloc();
