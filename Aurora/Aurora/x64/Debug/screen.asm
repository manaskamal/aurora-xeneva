...
$SG3297	DB	'fb', 00H
	ORG $+5
$SG3298	DB	'VFS Node created', 0aH, 00H
	ORG $+6
$SG3299	DB	'/dev/fb', 00H
$SG3300	DB	'VFS DEV FB Registered', 0aH, 00H
CONST	ENDS
...
; 53   : 	svga->flags = FS_FLAG_GENERAL | FS_FLAG_DEVICE;
