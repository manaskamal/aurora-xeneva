...
_BSS	ENDS
CONST	SEGMENT
$SG3869	DB	'[AHCI]: Taking the control from firmware took %d ms', 0aH
	DB	00H
	ORG $+3
$SG3895	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3896	DB	'AHCI/SATA not found', 0aH, 00H
	ORG $+3
$SG3897	DB	'Xeneva initialisation failed', 0aH, 00H
	ORG $+2
$SG3898	DB	'Halting System', 0aH, 00H
$SG3899	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3906	DB	'AHCI/SATA found at dev -> %d, func -> %d, bus -> %d', 0aH
	DB	00H
	ORG $+3
$SG3912	DB	'[AHCI]: Version -- %d.%d', 0aH, 00H
	ORG $+6
$SG3915	DB	'[AHCI]: 64-bit DMA supported', 0aH, 00H
	ORG $+2
$SG3917	DB	'[AHCI]: Num Command Slots -> %d', 0aH, 00H
	ORG $+7
$SG3920	DB	'[AHCI]: Support Staggered spin-up %d', 0aH, 00H
	ORG $+2
$SG3922	DB	'[AHCI]: FIS-Based Switching supported', 0aH, 00H
	ORG $+1
$SG3931	DB	'[AHCI]: SATA Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3934	DB	'[AHCI]: SATAPI Drive found at port %d', 0aH, 00H
	ORG $+1
$SG3937	DB	'[AHCI]: SEMB Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3940	DB	'[AHCI]: PM Drive found at port %d', 0aH, 00H
CONST	ENDS
