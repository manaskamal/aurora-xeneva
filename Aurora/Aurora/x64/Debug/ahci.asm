...
_BSS	ENDS
CONST	SEGMENT
$SG3662	DB	'[AHCI]: Taking the control from firmware took %d ms', 0aH
	DB	00H
	ORG $+3
$SG3676	DB	'AHCIInterrupt ', 0dH, 0aH, 00H
	ORG $+7
$SG3684	DB	'AHCI Device -> %x ', 0aH, 00H
	ORG $+4
$SG3688	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3689	DB	'AHCI/SATA not found', 0aH, 00H
	ORG $+3
$SG3690	DB	'Xeneva initialisation failed', 0aH, 00H
	ORG $+2
$SG3691	DB	'Halting System', 0aH, 00H
$SG3692	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3697	DB	'AHCI INTERRUPT LINE -> %d ', 0dH, 0aH, 00H
	ORG $+3
$SG3699	DB	'AHCI/SATA found BAR -> %x ', 0aH, 00H
	ORG $+4
$SG3711	DB	'[AHCI]: Version -- %d.%d', 0aH, 00H
	ORG $+6
$SG3714	DB	'[AHCI]: 64-bit DMA supported', 0aH, 00H
	ORG $+2
$SG3716	DB	'[AHCI]: Num Command Slots -> %d', 0aH, 00H
	ORG $+7
$SG3719	DB	'[AHCI]: Support Staggered spin-up %d', 0aH, 00H
	ORG $+2
$SG3721	DB	'[AHCI]: FIS-Based Switching supported', 0aH, 00H
	ORG $+1
$SG3730	DB	'[AHCI]: SATA Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3733	DB	'[AHCI]: SATAPI Drive found at port %d', 0aH, 00H
	ORG $+1
$SG3736	DB	'[AHCI]: SEMB Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3739	DB	'[AHCI]: PM Drive found at port %d', 0aH, 00H
CONST	ENDS
