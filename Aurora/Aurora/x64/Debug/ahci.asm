...
_BSS	ENDS
CONST	SEGMENT
$SG3660	DB	'[AHCI]: Taking the control from firmware took %d ms', 0aH
	DB	00H
	ORG $+3
$SG3681	DB	'AHCI device -> %x ', 0aH, 00H
	ORG $+4
$SG3685	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3686	DB	'AHCI/SATA not found', 0aH, 00H
	ORG $+3
$SG3687	DB	'Xeneva initialisation failed', 0aH, 00H
	ORG $+2
$SG3688	DB	'Halting System', 0aH, 00H
$SG3689	DB	'*******************************', 0aH, 00H
	ORG $+7
$SG3694	DB	'AHCI INTERRUPT LINE -> %d ', 0dH, 0aH, 00H
	ORG $+3
$SG3696	DB	'AHCI/SATA found BAR -> %x ', 0aH, 00H
	ORG $+4
$SG3705	DB	'[AHCI]: Version -- %d.%d', 0aH, 00H
	ORG $+6
$SG3708	DB	'[AHCI]: 64-bit DMA supported', 0aH, 00H
	ORG $+2
$SG3710	DB	'[AHCI]: Num Command Slots -> %d', 0aH, 00H
	ORG $+7
$SG3713	DB	'[AHCI]: Support Staggered spin-up %d', 0aH, 00H
	ORG $+2
$SG3715	DB	'[AHCI]: FIS-Based Switching supported', 0aH, 00H
	ORG $+1
$SG3724	DB	'[AHCI]: SATA Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3727	DB	'[AHCI]: SATAPI Drive found at port %d', 0aH, 00H
	ORG $+1
$SG3730	DB	'[AHCI]: SEMB Drive found at port %d', 0aH, 00H
	ORG $+3
$SG3733	DB	'[AHCI]: PM Drive found at port %d', 0aH, 00H
CONST	ENDS
