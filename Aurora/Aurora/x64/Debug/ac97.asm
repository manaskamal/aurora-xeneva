...
_BSS	ENDS
CONST	SEGMENT
$SG3297	DB	'AC97 interrupt fired++', 0aH, 00H
$SG3317	DB	'No AC97 device found', 0aH, 00H
	ORG $+2
$SG3318	DB	'AC97 Device found with device id -> %x, vendor id -> %x', 0aH
	DB	00H
	ORG $+7
$SG3321	DB	'AC97 interrupt line -> %d', 0aH, 00H
	ORG $+5
$SG3322	DB	'AC97 NAMBAR -> %x, NABMBAR -> %x', 0aH, 00H
	ORG $+6
$SG3323	DB	'AC97 NAMBAR -> %x, NABMBAR -> %x', 0aH, 00H
	ORG $+6
$SG3325	DB	'AC97 channels: %d', 0aH, 00H
	ORG $+5
$SG3327	DB	'20 bit sound supported', 0aH, 00H
$SG3330	DB	'Bit could not be cleared', 0aH, 00H
	ORG $+6
$SG3331	DB	'AC97 Sample Rate -> %d Hz', 0aH, 00H
	ORG $+5
$SG3333	DB	'AC97 initialized', 0aH, 00H
	ORG $+6
$SG3338	DB	'VAL = %x', 0aH, 00H
CONST	ENDS
