...
_BSS	ENDS
CONST	SEGMENT
$SG3277	DB	'AC97 interrupt fired++', 0aH, 00H
$SG3297	DB	'No AC97 device found', 0aH, 00H
	ORG $+2
$SG3298	DB	'AC97 Device found with device id -> %x, vendor id -> %x', 0aH
	DB	00H
	ORG $+7
$SG3301	DB	'AC97 interrupt line -> %d', 0aH, 00H
	ORG $+5
$SG3302	DB	'AC97 NAMBAR -> %x, NABMBAR -> %x', 0aH, 00H
	ORG $+6
$SG3303	DB	'AC97 NAMBAR -> %x, NABMBAR -> %x', 0aH, 00H
	ORG $+6
$SG3305	DB	'AC97 channels: %d', 0aH, 00H
	ORG $+5
$SG3307	DB	'20 bit sound supported', 0aH, 00H
$SG3310	DB	'Bit could not be cleared', 0aH, 00H
	ORG $+6
$SG3311	DB	'AC97 Sample Rate -> %d Hz', 0aH, 00H
	ORG $+5
$SG3313	DB	'AC97 initialized', 0aH, 00H
	ORG $+6
$SG3318	DB	'VAL = %x', 0aH, 00H
CONST	ENDS
