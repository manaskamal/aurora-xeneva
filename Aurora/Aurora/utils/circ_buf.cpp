...
circ_buf_t *circ_buf_init (char* buffer, size_t size) {
...
void circular_buf_put(circ_buf_t *cbuf, char data)
{
...
int circular_buf_put2(circ_buf_t *cbuf, char data)
{
	int r = -1;
...
int circular_buf_get(circ_buf_t *cbuf, char *data)
{
	int r = -1;
