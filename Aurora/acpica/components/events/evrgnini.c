    ...
    void                    **RegionContext)
{
    ...
    LocalRegionContext = (ACPI_MEM_SPACE_CONTEXT*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_MEM_SPACE_CONTEXT));
    ...
    void                    **RegionContext)
{
    ...
    UINT64                  PciValue;
    ACPI_PCI_ID             *PciId = (ACPI_PCI_ID*)RegionContext;
    ...
    *RegionContext = NULL;
    ...
    PciId = (ACPI_PCI_ID*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_PCI_ID));
    if (!PciId)
    {
        return_ACPI_STATUS (AE_NO_MEMORY);
    }
