    ...
    ACPI_GPE_BLOCK_INFO     *GpeBlock)
{
    ...
    GpeRegisterInfo = (ACPI_GPE_REGISTER_INFO*)ACPI_ALLOCATE_ZEROED (
     ...
     */
    GpeEventInfo = (ACPI_GPE_EVENT_INFO*)ACPI_ALLOCATE_ZEROED ((ACPI_SIZE) GpeBlock->GpeCount *
    ...
    ACPI_GPE_BLOCK_INFO     **ReturnGpeBlock)
{
    ...
    GpeBlock = (ACPI_GPE_BLOCK_INFO*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_GPE_BLOCK_INFO));
    if (!GpeBlock)
    {
        return_ACPI_STATUS (AE_NO_MEMORY);
    }
