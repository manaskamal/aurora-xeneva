    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    case ACPI_TYPE_LOCAL_REFERENCE:
        ...
        case ACPI_REFCLASS_NAME:   /* Reference to a named object */
                ...
                (StackDesc->Reference.Node->Type == ACPI_TYPE_THERMAL))
            {
                ...
                *StackPtr = (ACPI_OPERAND_OBJECT*) StackDesc->Reference.Node;
            }
            else
            {
    ...
    case ACPI_TYPE_LOCAL_INDEX_FIELD:
        ...
        *StackPtr = (ACPI_OPERAND_OBJECT*) ObjDesc;
        break;
...
{
    ACPI_OPERAND_OBJECT     *ObjDesc = (ACPI_OPERAND_OBJECT*) Operand;
    ...
    while (ObjDesc->Common.Type == ACPI_TYPE_LOCAL_REFERENCE)
    {
        ...
        case ACPI_REFCLASS_NAME:
            ...
            {
                Node = (ACPI_NAMESPACE_NODE*)ObjDesc->Reference.Object;
            }
