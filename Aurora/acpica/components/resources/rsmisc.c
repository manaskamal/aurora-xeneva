    ...
    ACPI_RSCONVERT_INFO     *Info)
{
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_SOURCE:
            ...
            Resource->Length +=
                AcpiRsGetResourceSource (AmlResourceLength, Info->Value,
                    (ACPI_RESOURCE_SOURCE*)Destination, Aml, NULL);
            break;
        ...
        case ACPI_RSC_SOURCEX:
            ...
            Resource->Length +=
                AcpiRsGetResourceSource (AmlResourceLength, (ACPI_RS_LENGTH)
                   ...
                   (ACPI_RESOURCE_SOURCE*) Destination, Aml, Target);
            break;
        ...
        case ACPI_RSC_BITMASK:
             ...
             */
            ItemCount = AcpiRsDecodeBitmask (ACPI_GET8 (Source),(UINT8*) Destination);
            if (ItemCount)
            {
        ...
        case ACPI_RSC_BITMASK16:
            ...
            ItemCount = AcpiRsDecodeBitmask (Temp16,(UINT8*) Destination);
            if (ItemCount)
            {
                Resource->Length += (ItemCount - 1);
            }
    ...
    while (Count)
    {
        ...
        case ACPI_RSC_SOURCEX:
            ...
            AmlLength = AcpiRsSetResourceSource (
                            Aml, (ACPI_RS_LENGTH) AmlLength, (ACPI_RESOURCE_SOURCE*)Source);
            AcpiRsSetResourceLength (AmlLength, Aml);
            break;
        ...
        case ACPI_RSC_BITMASK:
             ...
             */
            ACPI_SET8 (Destination,
                AcpiRsEncodeBitmask ((UINT8*)Source,
        ...
        case ACPI_RSC_BITMASK16:
             ...
             * 16-bit encoded bitmask (IRQ macro)
             */
            Temp16 = AcpiRsEncodeBitmask ((UINT8*)Source,
                        *ACPI_ADD_PTR (UINT8, Resource, Info->Value));
