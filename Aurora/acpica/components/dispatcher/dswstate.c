    ...
    ACPI_THREAD_STATE       *Thread)
{
    ...
    WalkState = (ACPI_WALK_STATE*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_WALK_STATE));
    if (!WalkState)
    {
        return_PTR (NULL);
    }
    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    while (WalkState->ControlState)
    {
        ...
        WalkState->ControlState = (ACPI_GENERIC_STATE*)State->Common.Next;
    ...
    while (WalkState->ScopeInfo)
    {
        ...
        WalkState->ScopeInfo = (ACPI_GENERIC_STATE*)State->Common.Next;
    ...
    {
        State = WalkState->Results;
        WalkState->Results = (ACPI_GENERIC_STATE*)State->Common.Next;
