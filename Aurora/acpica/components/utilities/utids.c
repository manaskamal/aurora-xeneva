    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    Hid = (ACPI_PNP_DEVICE_ID*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_PNP_DEVICE_ID) + (ACPI_SIZE) Length);
    if (!Hid)
    {
        Status = AE_NO_MEMORY;
        goto Cleanup;
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    Sub = (ACPI_PNP_DEVICE_ID*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_PNP_DEVICE_ID) + (ACPI_SIZE) Length);
    if (!Sub)
    {
        Status = AE_NO_MEMORY;
        goto Cleanup;
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    Uid = (ACPI_PNP_DEVICE_ID*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_PNP_DEVICE_ID) + (ACPI_SIZE) Length);
    if (!Uid)
    {
        Status = AE_NO_MEMORY;
        goto Cleanup;
    ...
    ACPI_PNP_DEVICE_ID_LIST **ReturnCidList)
{
    ...
    CidList = (ACPI_PNP_DEVICE_ID_LIST*)ACPI_ALLOCATE_ZEROED (CidListSize);
    if (!CidList)
    {
        Status = AE_NO_MEMORY;
        goto Cleanup;
    ...
    ACPI_PNP_DEVICE_ID      **ReturnId)
{
    ...
    Cls = (ACPI_PNP_DEVICE_ID*)ACPI_ALLOCATE_ZEROED (sizeof (ACPI_PNP_DEVICE_ID) + (ACPI_SIZE) Length);
    if (!Cls)
    {
        Status = AE_NO_MEMORY;
        goto Cleanup;
