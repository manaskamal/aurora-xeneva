    ...
    ACPI_OBJECT_TYPE        Type)
{
    ...
    Object = (ACPI_OPERAND_OBJECT*)AcpiUtAllocateObjectDescDbg (ModuleName, LineNumber, ComponentId);
    if (!Object)
    {
        return_PTR (NULL);
    }
    ...
    case ACPI_TYPE_LOCAL_BANK_FIELD:
        ...
        SecondObject = (ACPI_OPERAND_OBJECT*)AcpiUtAllocateObjectDescDbg (ModuleName,
    ...
    UINT32                  Count)
{
     ...
     * terminated.
     */
    PackageElements = (ACPI_OPERAND_OBJECT**) ACPI_ALLOCATE_ZEROED (
    ...
    ACPI_SIZE               BufferSize)
{
    ...
    if (BufferSize > 0)
    {
        ...
        Buffer = (UINT8*) ACPI_ALLOCATE_ZEROED (BufferSize);
        if (!Buffer)
        {
    ...
    ACPI_SIZE               StringSize)
{
     ...
     */
    String = (char*)ACPI_ALLOCATE_ZEROED (StringSize + 1);
    if (!String)
    {
        ACPI_ERROR ((AE_INFO, "Could not allocate size %u",
            (UINT32) StringSize));
    ...
    UINT32                  ComponentId)
{
    ...
    Object = (ACPI_OPERAND_OBJECT*)AcpiOsAcquireObject (AcpiGbl_OperandCache);
    if (!Object)
    {
