    ...
    ACPI_BUFFER             *RetBuffer)
{
    ...
    if (InternalObject->Common.Type == ACPI_TYPE_PACKAGE)
    {
        ...
        Status = AcpiUtCopyIpackageToEpackage (InternalObject,
                       (UINT8*) RetBuffer->Pointer, &RetBuffer->Length);
    }
    else
    {
        /*
    ...
    ACPI_OPERAND_OBJECT     **RetInternalObject)
{
    ...
    case ACPI_TYPE_STRING:
        ...
        InternalObject->String.Pointer = (char*)
    ...
    case ACPI_TYPE_BUFFER:
        ...
        InternalObject->Buffer.Pointer =(UINT8*)
    ...
    ACPI_OPERAND_OBJECT     *DestDesc)
{
    ...
    case ACPI_TYPE_LOCAL_REFERENCE:
        ...
        AcpiUtAddReference ((ACPI_OPERAND_OBJECT*)SourceDesc->Reference.Object);
        break;
    ...
    ACPI_WALK_STATE         *WalkState)
{
     ...
     */
    DestObj->Package.Elements = (ACPI_OPERAND_OBJECT**) ACPI_ALLOCATE_ZEROED (
