    ...
    ACPI_GENERIC_STATE      **ListHead)
{
    ...
    if (State)
    {
        ...
        *ListHead = (ACPI_GENERIC_STATE*)State->Common.Next;
    }
    ...
    void)
{
    ...
    State = (ACPI_GENERIC_STATE*)AcpiOsAcquireObject (AcpiGbl_StateCache);
    if (State)
    {
        /* Initialize */
    ...
    UINT16                  Index)
{
    ...
    State->Pkg.DestObject = (ACPI_OPERAND_OBJECT *)ExternalObject;
