    ...
    ACPI_BUFFER             *ReturnBuffer)
{
    ...
    if (ExternalParams && ExternalParams->Count)
    {
         ...
         */
        Info->Parameters = (ACPI_OPERAND_OBJECT**)ACPI_ALLOCATE_ZEROED (
    ...
    ACPI_EVALUATE_INFO      *Info)
{
    ...
    case ACPI_REFCLASS_REFOF:
        ...
        Node = (ACPI_NAMESPACE_NODE*)Info->ReturnObject->Reference.Object;
        if (Node)
        {
            ObjDesc = Node->Object;
        }
...
AcpiNsGetDeviceCallback (
    ...
    void                    **ReturnValue)
{
    ACPI_GET_DEVICES_INFO   *Info = (ACPI_GET_DEVICES_INFO*)Context;
    ACPI_STATUS             Status;
    ACPI_NAMESPACE_NODE     *Node;
    UINT32                  Flags;
