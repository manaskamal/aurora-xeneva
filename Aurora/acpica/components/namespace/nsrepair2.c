...
{
    {(const char)"_ALR", (char)AcpiNsRepair_ALR},
    {(const char)"_CID", (char)AcpiNsRepair_CID},
    {(const char)"_CST", (char)AcpiNsRepair_CST},
    {(const char)"_FDE", (char)AcpiNsRepair_FDE},
    {(const char)"_GTM", (char)AcpiNsRepair_FDE},     /* _GTM has same repair as _FDE */
    {(const char)"_HID", (char)AcpiNsRepair_HID},
    {(const char)"_PRT", (char)AcpiNsRepair_PRT},
    {(const char)"_PSS", (char)AcpiNsRepair_PSS},
    {(const char)"_TSS", (char)AcpiNsRepair_TSS},
